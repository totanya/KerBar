...
namespace KerBar.Module.BusinessObjects.Actions
{
    ...
    public class BankLine : BaseObject
    { // Inherit from a different class to provide a custom primary key, concurrency and deletion behavior, etc. (https://documentation.devexpress.com/eXpressAppFramework/CustomDocument113146.aspx).
        public BankLine(Session session)
            : base(session)
        {
        }
        ...
        [Association("Partner-PartnerLines")]
        public Partner Partner
        {
            get => partner;
            set => SetPropertyValue(nameof(Partner), ref partner, value);
        }

        [Association("double-PartnerLines")]
        ...
        public Currency Currency
        {
            ...
            set
            {
                SetPropertyValue(nameof(Currency), ref currency, value);
